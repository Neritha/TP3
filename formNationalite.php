...
<div class="container mt-5">
    ...
    <form action="valideFormNationalite.php?action=<?php echo $action ?> " method="post" class="col-md-6 offset-md-3 border border-primary p-3 rounded">
        ...
        <div class="form-group">
            <label for="libelle"> Contient </label>
        ...
        <div class="row">
            <div class="col"><a href="listeNationalites.php" class="btn btn-danger btn-block">Revenir à la liste <i class="fas fa-sign-out-alt"></i></a></div>
            <div class="col"><button type="submit" class="btn btn-success btn-block"><?php echo $action;?> <i class="fas fa-check"></i></button></div>
        </div>
    </form>   
</div>
